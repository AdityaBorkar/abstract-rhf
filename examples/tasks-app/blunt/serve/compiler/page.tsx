...
import { jsx } from '#/blunt/constants/jsx';
...
export async function CompilePage({
	...
	const Page = await import(`#/src/pages/${PageFile.path}`);
	...
	const result = await Bun.build({
		...
		entrypoints: ['blunt/constants/index.html'],
		outdir: '.blunt',
		minify: false,
		splitting: false,
		sourcemap: 'linked',
	...
	// HTML Template:
	let output_html = await file('./.blunt/index.html').text();
